...
description: Simplifica el teu codi de React amb aquestes utilitats útils de cerca difusa.
---
...
Amb només **unes poques línies de codi**, pots implementar una cerca difusa que retorna resultats coincidents i **ressalta els caràcters coincidents**:
