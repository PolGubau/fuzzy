...
# Framework agnostic Fuzzy finder🔍
...
This is how **@polgubau/fuzzy** ended up being an optimized  
library designed with TypeScript from the roots. You just need to type  
...
## Next steps
Now that you know what **@polgubau/fuzzy** is, let's get started with the installation.
