...
Después de perder algunas tardes intentando crear un **"fuzzy finder"** para un "side project", decidí exportarlo  
como una librería de código abierto que pudiera ayudarme (y a otros desarrolladores) en el futuro.
...
Solo necesitas escribir un comando y llamar a una función para obtener un buscador difuso en tu proyecto.
...
## Próximos pasos
Ahora que sabes qué es **@polgubau/fuzzy**, comencemos con la instalación.

<Cards>
  <Card title="Guía de instalación" href="/docs/installation" />
  <Card title="Ejemplos de uso" href="/docs/examples" />
</Cards>
