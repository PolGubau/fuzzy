...
description: Simplifica tu código de React con estas útiles utilidades de búsqueda difusa.
---
...
Con solo **unas pocas líneas de código**, puedes implementar una búsqueda difusa que devuelve resultados coincidentes y **resalta los caracteres coincidentes**:
